...
public class GraphQLParser extends Parser {
	...
	public static class ExecutableDocumentContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_executableDocument; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GraphQLListener ) ((GraphQLListener)listener).enterExecutableDocument(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GraphQLListener ) ((GraphQLListener)listener).exitExecutableDocument(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GraphQLVisitor ) return ((GraphQLVisitor<? extends T>)visitor).visitExecutableDocument(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Type_Context extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GraphQLVisitor ) return ((GraphQLVisitor<? extends T>)visitor).visitType_(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeSystemDocumentContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_typeSystemDocument; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GraphQLListener ) ((GraphQLListener)listener).enterTypeSystemDocument(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GraphQLListener ) ((GraphQLListener)listener).exitTypeSystemDocument(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GraphQLVisitor ) return ((GraphQLVisitor<? extends T>)visitor).visitTypeSystemDocument(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeSystemExtensionDocumentContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_typeSystemExtensionDocument; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GraphQLListener ) ((GraphQLListener)listener).enterTypeSystemExtensionDocument(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GraphQLListener ) ((GraphQLListener)listener).exitTypeSystemExtensionDocument(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GraphQLVisitor ) return ((GraphQLVisitor<? extends T>)visitor).visitTypeSystemExtensionDocument(this);
			else return visitor.visitChildren(this);
		}
	}

	public final TypeSystemExtensionDocumentContext typeSystemExtensionDocument() throws RecognitionException {
		TypeSystemExtensionDocumentContext _localctx = new TypeSystemExtensionDocumentContext(_ctx, getState());
